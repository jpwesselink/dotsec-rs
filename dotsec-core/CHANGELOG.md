...
## [7.0.2](https://github.com/jpwesselink/dotsec-rs/compare/dotsec-core-v7.0.1...dotsec-core-v7.0.2) - 2026-07-14
...
- *(decrypt)* MAC failure now points at the specific drift vs git HEAD ([#50](https://github.com/jpwesselink/dotsec-rs/pull/50))
...
- release v7.0.1 ([#48](https://github.com/jpwesselink/dotsec-rs/pull/48))
- release v7.0.0 ([#43](https://github.com/jpwesselink/dotsec-rs/pull/43))
...
## [7.0.1](https://github.com/jpwesselink/dotsec-rs/compare/dotsec-core-v7.0.0...dotsec-core-v7.0.1) - 2026-06-13
