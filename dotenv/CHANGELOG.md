...
## [7.0.2](https://github.com/jpwesselink/dotsec-rs/compare/dotenv-v0.15.0...dotenv-v7.0.2) - 2026-07-14
...
- *(dotenv)* strip trailing \r from unquoted values to make round-trips stable ([#39](https://github.com/jpwesselink/dotsec-rs/pull/39))
